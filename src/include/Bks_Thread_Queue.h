...
enum _Bks_Thread_Type {
     ...
     BKS_THREAD_TYPE_PRODUCTS_ALPHA_GET,
     BKS_THREAD_TYPE_PRODUCTS_ALPHA_GET_FINISHED,
     BKS_THREAD_TYPE_PRODUCTS_FAVS_GET,
     BKS_THREAD_TYPE_PRODUCTS_FAVS_GET_FINISHED
};
